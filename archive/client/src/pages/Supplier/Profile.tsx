      ...
      <div className="bg-white rounded-lg p-6 shadow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <p className="font-medium">{profile.supplierId || "N/A"}</p>
          </div>
          <div>
        ...
        {/* Action buttons for supplier management */}
        <div className="mt-6 pt-6 border-t">
          <h3 className="text-sm font-medium text-gray-500 mb-3">Supplier Actions</h3>
